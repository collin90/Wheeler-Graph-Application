...
import PatternMatchingTutorial from "../components/PatternMatchingTutorial";
        ...
        <Container>
            ...
            <MathJax.Provider>
                ...
                <Box pt={3} ml={4}>
                    ...
                    <Typography variant="body1" ml={4} display="inline">
                    ...
                    <Typography variant="body1" className="has-popup" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}> bitvectors.</Typography>
                    {popUp && <p className="popup"> A bitvector is an array of bits </p>}
                    <Typography variant="body1" display="inline">  
                        To understand how to store a Wheeler graph in bitvectors,
                    ...
                    <Box py={2} sx={{ border: 3 }} mt={2}>
                        <div style={{ width: 'auto', height: window.innerHeight / 1.5 }}>
                            <InteractiveGraphWithOILC />
                        </div>
                    </Box>
                    <Typography variant="h5" sx={{ fontWeight: 'medium' }} mt={30} > Pattern Matching Inquiry </Typography>
                    ...
                    <Typography variant="body1" pb={5}>
                        The following example matches "BCA" to the graph.
                    </Typography>
