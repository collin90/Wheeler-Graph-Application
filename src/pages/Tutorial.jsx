    ...
    return (
        <Container>
            <MathJax.Provider>
                ...
                <Box>
                    <Typography variant="body1"> A directed edge-labeled graph, where each label is from a totally-ordered alphabet, is a <b>Wheeler Graph</b> if: </Typography>
                ...
                <Box pt={3}>
                    <Typography variant="h4" sx={{ fontWeight: 'medium' }}> Why are Wheeler Graphs important? </Typography>
                </Box>
                <Box>
                    <Typography variant="body1"> Wheeler graphs are desirable because they have the <b>path coherence</b> property, meaning that for any string, we can order nodes consecutively from the initial state to process that string. This property allows for the graph to be stored compactly </Typography>
                    <br></br>
                    <Typography variant="body1">
                        Given a graph G = (V,E), where V = set of vertices and E = set of edges, and σ is the size of the alphabet. |V| = n, |E|= e. Then, the graph may be stored in
                        <MathJax.Node inline formula={` \\: 2(e + n)+ e\\log\\sigma + \\sigma\\log e + o(n+e\\log\\sigma) \\:`} />
                        bits.
                    </Typography>
                </Box>
            </MathJax.Provider>
