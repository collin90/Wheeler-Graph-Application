#this funtion does the exact same thing as getOILC, but it just doesnt compress O and I. Compressing O and I only makes sense for strings and multistrings,
#but this function is called by the interactive graph component, which doesn't ask you to build string/multistring wheeler graphs.
def getOILCbasic (nodes, edges): 
    ...
    return {'O': O, 'I': I, 'L': L_compressed, 'C': str(C)}